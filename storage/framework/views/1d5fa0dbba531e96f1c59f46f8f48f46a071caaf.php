                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                                                <div class="row mb-1">
                                                    <div class="col-sm-12">
                                                        <?php echo Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone', 'files' => true)); ?>

                                                        <?php echo e(csrf_field()); ?>

                                                        <div class="form-group has-feedback <?php echo e($errors->has('avatar') ? ' has-error ' : ''); ?>">
                                                            <?php echo Form::label('file', trans('profile.avatar'), array('class' => 'col-md-12 control-label'));; ?>

                                                            <div class="col-8">
                                                                <div class="custom-file">
                                                                    <input type="file" name="user-avatar" class="custom-file-input" id="userAvatar" accept=".jpg,.png">
                                                                    <label class="custom-file-label" for="customFile">Choose Avatar</label>
                                                                </div>
                                                                <?php if($errors->has('offersFile')): ?>
                                                                    <span class="help-block">
                                                                    <strong><?php echo e($errors->first('user-avatar')); ?></strong>
                                                                </span>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="col-4">
                                                                <?php echo Form::button(trans('profile.update_avatar_image'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )); ?>

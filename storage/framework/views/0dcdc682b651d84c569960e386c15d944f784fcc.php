<?php $__env->startSection('template_title'); ?>
    <?php echo app('translator')->getFromJson('offermanagement.editing-offer',['product'=>$offer->product]); ?>
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                ...
                                <a href="<?php echo URL::to('offers/'.$offer->retailer_id.'/'.$date.'/details/'); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo app('translator')->getFromJson('offermanagement.tooltips.back-offers'); ?>">
                                    <i class="fa fa-fw fa-reply-all" aria-hidden="true"></i>
                                    <?php echo app('translator')->getFromJson('offermanagement.buttons.back-to-offers-detail'); ?>
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <?php echo Form::open(array('route' => ['offers.update', $offer->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('availability_id') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo e(Form::select('availability_id', $arr_available, $offer->availability_id, array('class'=>"form-control chosen-select",'id'=>'availability_id'))); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('date') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('date', $offer->date, array('id' => 'date', 'class' => 'form-control', 'value' => date('mm/dd/YY'))); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('date_code') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('date_code',$offer->date_code, array('id' => 'date', 'class' => 'form-control' )); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('retailer_id') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo e(Form::select('retailer_id', $arr_retailer, $offer->retailer_id, array('class'=>"form-control chosen-select",'id'=>'retailer_id'))); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('product') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('product',$offer->product, array('id' => 'product', 'class' => 'form-control' )); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('current_price') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::number('current_price',$offer->current_price, array('id' => 'current_price', 'class' => 'form-control' ,'step'=>'0.01')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('discount_offer') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('discount_offer',$offer->discount_offer, array('id' => 'discount_offer', 'class' => 'form-control')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('image_url') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('image_url',$offer->image_url, array('id' => 'image_url', 'class' => 'form-control' )); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('department_id') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo e(Form::select('department_id', $arr_department, $offer->department_id, array('class'=>"form-control chosen-select",'id'=>'department_id'))); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('category') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('category',$offer->category, array('id' => 'category', 'class' => 'form-control' )); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('offer_url') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('offer_url',$offer->offer_url, array('id' => 'offer_url', 'class' => 'form-control' )); ?>

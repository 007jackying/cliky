<?php $__env->startSection('template_title'); ?>
    <?php echo app('translator')->getFromJson('usersmanagement.showing-all-users'); ?>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="btn-group pull-right btn-group-xs">
                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <span class="sr-only">
                                        <?php echo app('translator')->getFromJson('usersmanagement.users-menu-alt'); ?>
                                    </span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="/users/create">
                                        <i class="fa fa-fw fa-user-plus" aria-hidden="true"></i>
                                        <?php echo app('translator')->getFromJson('usersmanagement.buttons.create-new'); ?>
                                    </a>
                                    <a class="dropdown-item" href="/users/deleted">
                                        <i class="fa fa-fw fa-group" aria-hidden="true"></i>
                                        <?php echo app('translator')->getFromJson('usersmanagement.show-deleted-users'); ?>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive users-table">
                            <table class="table table-striped table-sm data-table">
                                ...
                                <thead class="thead">
                                    <tr>
                                        <th><?php echo app('translator')->getFromJson('usersmanagement.users-table.id'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('usersmanagement.users-table.name'); ?></th>
                                        <th class="hidden-xs"><?php echo app('translator')->getFromJson('usersmanagement.users-table.email'); ?></th>
                                        <th class="hidden-xs"><?php echo app('translator')->getFromJson('usersmanagement.users-table.fname'); ?></th>
                                        <th class="hidden-xs"><?php echo app('translator')->getFromJson('usersmanagement.users-table.lname'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('usersmanagement.users-table.role'); ?></th>
                                        <th class="hidden-sm hidden-xs hidden-md"><?php echo app('translator')->getFromJson('usersmanagement.users-table.created'); ?></th>
                                        <th class="hidden-sm hidden-xs hidden-md"><?php echo app('translator')->getFromJson('usersmanagement.users-table.updated'); ?></th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-success btn-block" href="<?php echo e(URL::to('users/' . $user->id)); ?>" data-toggle="tooltip" title="Show">
                                                    <?php echo app('translator')->getFromJson('usersmanagement.buttons.show'); ?>
                                                </a>
                                            </td>
                                            <td>
                                                <a class="btn btn-sm btn-info btn-block" href="<?php echo e(URL::to('users/' . $user->id . '/edit')); ?>" data-toggle="tooltip" title="Edit">
                                                    <?php echo app('translator')->getFromJson('usersmanagement.buttons.edit'); ?>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

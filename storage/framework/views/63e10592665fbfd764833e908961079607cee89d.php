<?php $__env->startSection('template_title'); ?>
    <?php echo app('translator')->getFromJson('usersmanagement.editing-user', ['name' => $user->name]); ?>
                    ...
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo e(route('users')); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="top" title="<?php echo app('translator')->getFromJson('usersmanagement.tooltips.back-users'); ?>">
                                    <i class="fa fa-fw fa-reply-all" aria-hidden="true"></i>
                                    <?php echo app('translator')->getFromJson('usersmanagement.buttons.back-to-users'); ?>
                                </a>
                                <a href="<?php echo e(url('/users/' . $user->id)); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo app('translator')->getFromJson('usersmanagement.tooltips.back-users'); ?>">
                                    <i class="fa fa-fw fa-reply" aria-hidden="true"></i>
                                    <?php echo app('translator')->getFromJson('usersmanagement.buttons.back-to-user'); ?>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <?php echo Form::open(array('route' => ['users.update', $user->id], 'method' => 'PUT', 'role' => 'form', 'class' => 'needs-validation')); ?>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 mb-2">
                                    <a href="#" class="btn btn-outline-secondary btn-block btn-change-pw mt-3" title="<?php echo app('translator')->getFromJson('forms.change-pw'); ?>">
                                        <i class="fa fa-fw fa-lock" aria-hidden="true"></i>
                                        <span></span> <?php echo app('translator')->getFromJson('forms.change-pw'); ?>
                                    </a>
                                </div>

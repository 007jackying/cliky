    ...
    <table class="table table-striped table-condensed table-sm <?php if(config('LaravelLogger.enableDrillDown') && $hoverable): ?> table-hover <?php endif; ?> data-table">
            ...
            <tr>
                <th>
                    ...
                    <span class="hidden-sm hidden-xs">
                        <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.id'); ?>
                    </span>
                </th>
                <th>
                    <i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.time'); ?>
                </th>
                <th>
                    <i class="fa fa-file-text-o fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.description'); ?>
                </th>
                <th>
                    <i class="fa fa-user-o fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.user'); ?>
                </th>
                <th>
                    <i class="fa fa-truck fa-fw" aria-hidden="true"></i>
                    <span class="hidden-sm hidden-xs">
                        <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.method'); ?>
                    </span>
                </th>
                <th>
                    <i class="fa fa-map-o fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.route'); ?>
                </th>
                <th>
                    <i class="fa fa-map-marker fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.ipAddress'); ?>
                </th>
                <th>
                    <i class="fa fa-laptop fa-fw" aria-hidden="true"></i>
                    <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.agent'); ?>
                </th>
                <?php if(Request::is('activity/cleared')): ?>
                    <th>
                        <i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>
                        <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.dashboard.labels.deleteDate'); ?>
                    </th>
                <?php endif; ?>
            </tr>
        </thead>
        <tbody>
            <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr <?php if($drilldownStatus && $hoverable): ?> class="clickable-row" data-href="<?php echo e($prependUrl . $activity->id); ?>" data-toggle="tooltip" title="<?php echo e(trans('LaravelLogger::laravel-logger.tooltips.viewRecord')); ?>" <?php endif; ?> >
                    <td>
                        <small>
...
<?php if(config('LaravelLogger.loggerPaginationEnabled')): ?>
    <div class="text-center">
        ...
        <p>
            <?php echo app('translator')->getFromJson('LaravelLogger::laravel-logger.pagination.countText', ['firstItem' => $activities->firstItem(), 'lastItem' => $activities->lastItem(), 'total' => $activities->total(), 'perPage' => $activities->perPage()]); ?>
        </p>
    </div>
<?php endif; ?>

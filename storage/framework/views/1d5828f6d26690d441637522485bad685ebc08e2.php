<?php $__env->startSection('template_title'); ?>
  <?php echo app('translator')->getFromJson('usersmanagement.showing-user', ['name' => $user->name]); ?>
        ...
        <div class="card">
          ...
          <div class="card-header text-white <?php if($user->activated == 1): ?> bg-success <?php else: ?> bg-danger <?php endif; ?>">
            <div style="display: flex; justify-content: space-between; align-items: center;">
              <?php echo app('translator')->getFromJson('usersmanagement.showing-user-title', ['name' => $user->name]); ?>
              <div class="float-right">
                <a href="<?php echo e(route('users')); ?>" class="btn btn-light btn-sm float-right" data-toggle="tooltip" data-placement="left" title="<?php echo app('translator')->getFromJson('usersmanagement.tooltips.back-users'); ?>">
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-4 col-md-6">
                ...
                <p class="text-center text-left-tablet">
                  ...
                  <?php if($user->email): ?>
                    <br />
                    <span class="text-center" data-toggle="tooltip" data-placement="top" title="<?php echo app('translator')->getFromJson('usersmanagement.tooltips.email-user', ['user' => $user->email]); ?>">
            ...
            <div class="col-sm-7">
              <span data-toggle="tooltip" data-placement="top" title="<?php echo app('translator')->getFromJson('usersmanagement.tooltips.email-user', ['user' => $user->email]); ?>">
                <?php echo e(HTML::mailto($user->email, $user->email)); ?>

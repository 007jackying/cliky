        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <div class="pull-right">
                                <a href="{!! route('offers') !!}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="left" title="@lang('offermanagement.tooltips.back-offers')">
                    ...
                    <div class="card-body">
                        {!! Form::open(array('route' => 'offers.store', 'method' => 'POST', 'role' => 'form', 'class' => 'needs-validation')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('availability_id') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {{ Form::select('availability_id', $arr_available, old('availability_id'), array('class'=>"form-control chosen-select",'id'=>'availability_id')) }}
                                </div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('date') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('date', date('m/d/Y'), array('id' => 'date', 'class' => 'form-control', 'value' => date('mm/dd/YY'))) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('date_code') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('date_code',NULL, array('id' => 'date', 'class' => 'form-control' )) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('retailer_id') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {{ Form::select('retailer_id', $arr_retailer, old('retailer_id'), array('class'=>"form-control chosen-select",'id'=>'retailer_id')) }}
                                </div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('product') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('product',NULL, array('id' => 'product', 'class' => 'form-control' )) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('current_price') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('current_price',NULL, array('id' => 'current_price', 'class' => 'form-control' ,'step'=>'0.01')) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('discount_offer') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::number('discount_offer',NULL, array('id' => 'discount_offer', 'class' => 'form-control' ,'step'=>'0.01')) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('image_url') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('image_url',NULL, array('id' => 'image_url', 'class' => 'form-control' )) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('department_id') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {{ Form::select('department_id', $arr_department, old('department_id'), array('class'=>"form-control chosen-select",'id'=>'department_id')) }}
                                </div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('category') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('category',NULL, array('id' => 'category', 'class' => 'form-control' )) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">
                                            <i class="fa fa-fw fa-external-link" aria-hidden="true"></i>
                                        </label>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('offer_url') ? ' has-error ' : '' }}">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    {!! Form::text('offer_url',NULL, array('id' => 'offer_url', 'class' => 'form-control' )) !!}
                                    <div class="input-group-append">
                                        <label class="input-group-text" for="name">

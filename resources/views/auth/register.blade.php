                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="zip_code" type="text" class="form-control{{ $errors->has('zip_code') ? ' is-invalid' : '' }}" name="zip_code" value="{{ old('zip_code') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                {{ Form::select('country', $countries, old('country'), array('class'=>"form-control chosen-select",'id'=>'country')) }}

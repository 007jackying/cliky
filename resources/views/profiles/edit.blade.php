                                    ...
                                    <div class="col-12 col-sm-8 col-md-9">
                                        <div class="tab-content" id="v-pills-tabContent">
                                            <div class="tab-pane fade show active edit-profile-tab" role="tabpanel" aria-labelledby="edit-profile-tab">
                                                <div class="row mb-1">
                                                    <div class="col-sm-12">
                                                        {!! Form::open(array('route' => 'avatar.upload', 'method' => 'POST', 'name' => 'avatarDropzone', 'files' => true)) !!}
                                                        {{ csrf_field() }}
                                                        <div class="form-group has-feedback {{ $errors->has('avatar') ? ' has-error ' : '' }}">
                                                            {!! Form::label('file', trans('profile.avatar'), array('class' => 'col-md-12 control-label')); !!}
                                                            <div class="col-8">
                                                            ...
                                                            <div class="col-4">
                                                                {!! Form::button(trans('profile.update_avatar_image'), array('class' => 'btn btn-success margin-bottom-1 mb-1 float-right','type' => 'submit' )) !!}
                                                            </div>
                                                        {!! Form::close() !!}
                                                    </div>
                                                </div>
